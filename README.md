...
- Provides New, Open, Save via the system file picker, working mouse-wheel scrollbars, line numbers, a visual-only footer line-wrap toggle, and find/replace (`Ctrl+F`).
...
- Watches the palette and updates its UI silently after `omarchy theme set …`.
